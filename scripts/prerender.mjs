...
const proposalBody = `
  ...
  <main>
    ...
    <section><h2>Dal punto A al punto B</h2><p>Da una situazione professionale che non ti rappresenta più a una direzione chiara e un piano concreto per costruirla: attraverso un nuovo lavoro dipendente, un’attività indipendente o un percorso ibrido.</p></section>
    <section><h2>Tre sessioni per passare dalla confusione a una direzione possibile.</h2><ol><li>Respira: fotografiamo la situazione, distinguiamo limiti reali e convinzioni e riconosciamo le risorse disponibili.</li><li>Immagina: costruiamo una direzione coerente con valori, desideri, capacità e vita reale.</li><li>Agisci: trasformiamo la direzione in obiettivi, verifiche e primi passi concreti.</li></ol><p>Ogni sessione individuale dura da 60 a 120 minuti, in base al lavoro previsto per la singola fase.</p></section>
