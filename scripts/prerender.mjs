...
const proposalBody = `
  ...
  <main>
    ...
    <h1>Non devi mollare tutto. Devi costruire il passaggio.</h1>
    <p>Con Respira. Immagina. Agisci. proteggiamo la tua base attuale, definiamo il lavoro che desideri e prepariamo il ponte per raggiungerlo senza salti nel vuoto.</p>
    ...
    <section><h2>Il cambiamento non comincia lasciando il lavoro. Comincia costruendo una base per quello nuovo.</h2><ul><li>Se hai già un lavoro, lo mantieni mentre prepari e verifichi il nuovo.</li><li>Se ti serve reddito subito, cerchiamo anche un lavoro-ponte.</li><li>Se hai una reale autonomia economica, possiamo accelerare con criterio.</li></ul><p>Dal presente al lavoro desiderato attraverso un passaggio protetto, costruito sulla situazione reale.</p></section>
    <section><h2>Tre sessioni per costruire la strada, non per spingerti a saltare.</h2><ol><li>Respira: fotografiamo la situazione e definiamo la base di sicurezza da proteggere.</li><li>Immagina: costruiamo il lavoro desiderato e ne verifichiamo la compatibilità con la vita reale.</li><li>Agisci: prepariamo il ponte con prove, risorse, tempi e soglie prima del passaggio.</li></ol><p>Ogni sessione individuale dura da 60 a 120 minuti, in base al lavoro previsto per la singola fase.</p></section>
    ...
    <section><h2>La proposta riservata</h2><p>Valore delle tre sessioni: <s>600 euro</s>. Proposta: <strong>450 euro</strong>. Risparmio: 150 euro, pari al 25%.</p><p>Sono inclusi workbook, prima sessione conoscitiva gratuita, tre sessioni individuali da 60 a 120 minuti e supporto WhatsApp durante il percorso.</p><a href="https://wa.me/393497759350?text=Ciao%20Gabriele%2C%20vorrei%20iniziare%20il%20percorso%20di%20cambiamento%20professionale.">Parliamone su WhatsApp</a></section>
  </main>
  ${footer}`
